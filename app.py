...
# Main App Routing
def main():
    # 1. Create a "Clean Slate" placeholder
    # This forces Streamlit to treat the content as replaceable, 
    # ensuring old widgets (like video players) are wiped on every rerun.
    main_placeholder = st.container()
    main_placeholder.empty()
    
    # 2. Render everything INSIDE this placeholder
