...
# Dictionary mapping sign IDs to YouTube URLs and start times
SIGN_VIDEOS = {
    ...
    "Hello": ("https://youtu.be/SsLvqfTXo78?si=yXHCLarLXjqdYErM", 4),
    "Goodbye": ("https://youtu.be/SwhzH7GLL1k?si=VATv7AftByGUhPkk", 0),
    "תודה": ("https://youtu.be/iHl0fxyPeZI?si=GjWQ0fHXZlHmOkfz", 0),
    "בבקשה": ("https://youtu.be/7DZEsCrtmb8?si=iuaHUkDK5puR9BZv", 6),
    "כן": ("https://youtu.be/GDV3K8BXSQI?si=jKPpCmfhtt26PRyT", 62),
    ...
    "שלום": ("https://youtu.be/_LM_H7FfOmg?si=HYN8n2GURqVQ3pWr", 0),
    "להתראות": ("https://youtu.be/GDV3K8BXSQI?si=jKPpCmfhtt26PRyT", 59),
    "Dog": ("", ),
    "Cat": ("", ),
    "Horse": ("", ),
    "Bird": ("", ),
