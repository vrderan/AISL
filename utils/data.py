...
SIGN_VIDEOS = {
    ...
    "כן": ("https://youtu.be/ceFLZK3kTTY?si=sN8w8mNXaZXxivqB", 0, None),
    ...
    "Who": ("https://youtu.be/nUZAHEBLYbI?si=9_sMqixggRJKO1jj", 0, 9),
    "What": ("https://youtu.be/CK_tlyddtsY?si=fr3hfUqx6Ohezunu", 0, None),
    "When": ("https://youtu.be/3ljevbHiAqI?si=sa1aOE4XH3AKkryq", 0, None),
    "Where": ("https://youtu.be/EOa6TGNA1Fw?si=aZhO2P36aiD8i4Ji", 0, None),
    "Why": ("https://youtu.be/p62KvYKfKC8?si=mVbQrUXtdC3C1G4F", 14, 32),
    ...
    "Horse": ("https://youtu.be/Lf8Q9kL8F6U?si=OSaftNDLeN7bkw4I", 0, None),
    "Bird": ("https://youtu.be/YCKOcYe6oPk?si=3rrsGUVTUESmQ0gu", 0, None),
    "Fish": ("https://youtu.be/WWmOTMu5-Zw?si=rBU0yOoKrsQlsQ4w", 0, None),
    "Elephant": ("https://youtu.be/2oxexuos65s?si=CisqbFYmX0GLsOTy", 0, None),
    "Giraffe": ("https://youtu.be/nh6KCYn0HGo?si=vzOmnIuBsyxXnP8k", 0, None),
